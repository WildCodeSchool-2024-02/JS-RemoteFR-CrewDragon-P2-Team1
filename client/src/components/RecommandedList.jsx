...
const destinations = [
  ...
  },
  {
    ID: 39,
    Name: "Finland",
    Src: "https://cdn.pixabay.com/photo/2018/10/28/10/39/helsinki-3778360_640.jpg",
    Label: "Europe",
    Text: "Decouvrez sa modernité et sa tradition, tandis que le phénomène des aurores boréales illumine souvent les cieux nocturnes du nord.  ",
    TextDesktop:
      " La Finlande est réputée pour sa nature préservée, ses lacs scintillants et ses vastes forêts. Avec une société innovante et une qualité de vie élevée, elle se distingue également par son système éducatif de renommée mondia ",
    isFavorite: false,
    Capital: "Helsinki",
    CountryCode: "FI",
    Currency: "EUR",
  },
  {
    ...
    Label: "Europe",
    Text: "Decouvrez sa riche histoire, sa culture diversifiée, sa cuisine renommée, ses magnifiques paysages allant des montagnes des Alpes et des Pyrénées aux plages méditerranéennes.",
    TextDesktop:
      "Son patrimoine culturel riche, ses villes historiques pittoresques et ses nombreux monuments emblématiques en font une destination prisée par les voyageurs du monde entier.",
    Capital: "Paris",
    CountryCode: "FR",
    Currency: "EUR",
  },
  {
    ID: 42,
    Name: "Gabon",
    Src: "https://cdn.pixabay.com/photo/2019/04/24/14/44/libreville-4152252_640.jpg",
    Label: "Afrique",
    Text: "Decouvrez une riche culture, avec des traditions tribales préservées et des festivals colorés.",
    TextDesktop:
      "Le Gabon, situé en Afrique centrale, est connu pour sa biodiversité exceptionnelle, abritant une grande partie de la forêt équatoriale du continent.",
    Capital: "Libreville",
    CountryCode: "GA",
    Currency: "CFA",
  },
  {
    ID: 43,
    Name: "Grenada",
    Src: "https://cdn.pixabay.com/photo/2017/01/20/00/30/maldives-1993704_640.jpg",
    Label: "Amerique du nord",
    Text: "Decouvrez sa culture vibrante, avec une musique reggae envoûtante et une cuisine délicieuse mettant en valeur les saveurs locales.",
    TextDesktop:
      "Grenade, une île des Caraïbes, est réputée pour ses plages de sable blanc, ses eaux turquoise et son atmosphère relaxante. Cette destination offre une riche biodiversité, avec des cascades cachées, des forêts tropicales luxuriantes",
    Capital: "St. George's",
    CountryCode: "GD",
    Currency: "XCD",
  },
  {
    ID: 43,
    Name: "Georgia",
    Src: "https://cdn.pixabay.com/photo/2017/02/25/17/38/george-washington-bridge-2098351_640.jpg",
    Label: "Europe",
    Text: "Decouvrez sa riche histoire, sa culture vibrante, ses paysages montagneux spectaculaires et sa cuisine délicieuse.",
    TextDesktop:
      "La Géorgie est connue pour son patrimoine architectural, ses églises anciennes et ses traditions folkloriques en font une destination fascinante à découvrir.",
    Capital: "Tiblissi",
    CountryCode: "GE",
    Currency: "GEL",
  },
  {
    ID: 44,
    Name: "Guernsey",
    Src: "https://cdn.pixabay.com/photo/2017/06/11/16/52/boat-2392857_640.jpg",
    Label: "EUROPE",
    Text: "Profiter de la gastronomie locale, des activités de plein air telles que la randonnée et de l'accueil chaleureux de ses habitants.",
    TextDesktop:
      "Guernesey, une île anglo-normande située dans la Manche, est réputée pour son charme côtier, ses plages pittoresques et son atmosphère paisible. ",
  ...
  },
  {
    ID: 45,
    Name: "Gibraltar",
    Src: "https://cdn.pixabay.com/photo/2021/09/24/19/30/rock-of-gibraltar-6653389_640.jpg",
    Label: "EUROPE",
    Text: "Célèbre pour son emblématique rocher, ses vues imprenables sur le détroit de Gibraltar et sa position stratégique à l'entrée de la Méditerranée.",
    TextDesktop:
      "Gibraltar, un territoire britannique d'outre-mer. Connue pour son histoire riche, sa culture multiculturelle et sa faune variée.",
    Capital: "Gibraltar",
    CountryCode: "GI",
    Currency: "GBP",
  },
